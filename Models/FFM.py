...
def train_and_evaluate(X_train, y_train, X_val, y_val, field_indices, epochs, lr, reg, save_dir, grp_name, batch_size, k, device, session_name):
    ...
    log_dir = os.path.join(save_dir, "FFM_event", session_name, grp_name)
...
if __name__ == "__main__":
    ...
    def train_model_for_group(train_group, val_group, group_name):
        ...
        return train_and_evaluate(X_train, y_train, X_val, y_val, field_indices, args.epoch, args.lr, args.reg,
    ...
    if not args.treatment:
        ...
        train_and_evaluate(X_train, y_train, X_val, y_val, field_indices, args.epoch, args.lr, args.reg,
